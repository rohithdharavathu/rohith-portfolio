...
const experiences = [
  ...
  {
    company: 'Trianz',
    role: 'Product Software Engineer — AI / Cloud',
    period: 'Sep 2024 – Jan 2026',
    location: 'Bengaluru, India',
    bullets: [
      'Built and deployed an Agentic AI system using LLMs and LangChain to generate personalized employee learning paths — won Trianz internal AI Hackathon (Sept 2025).',
      'Engineered AWS cloud infrastructure for the Concierto Migrate platform using Terraform and AWS CloudFormation; designed GitLab CI/CD pipelines for blue/green deployments.',
      'Containerized microservices using Docker and orchestrated workloads on ECS Fargate; built Python and Boto3 automation scripts for data validation and post-migration testing.',
      'Led cloud migration readiness assessments integrating AWS Migration Hub, DMS, EC2, S3, and Lambda.',
    ],
    tags: ['Python', 'LangChain', 'OpenAI APIs', 'AWS', 'Terraform', 'Docker', 'GitLab CI/CD', 'FastAPI', 'DynamoDB'],
